...
contract LimYoonJeongCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function LimYoonJeongCoin() {
        ...
        name = "LimYoonJeongCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "LYG";                                             // Set the symbol for display purposes (CHANGE THIS)
